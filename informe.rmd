...
tabla anexa se mostrarán desglosados por objetivos y ordenados por cantidad de proyectos (anm's)
totales:
...
observar que todas excdpto una utilizan varias unidades de medición distintas.
...
por actividad prioritaria, y el número de registros comparables quese tendrían si
se tuvieran las unidades estandarizadas.

Cada actividad tendría, en promedio, 60 registros más de registros comprables si
